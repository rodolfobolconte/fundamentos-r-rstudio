...
#### Fonte do Tutorial: [Blog Dados Aleatórios](https://www.dadosaleatorios.com.br/post/introducao-ao-dplyr/)

### 1- Instalando o Tidyverse

O Tidyverse é um "pacote de pacotes" do R que possui o pacote Dplyr e Starwars, que consistem numa manipulação de dados mais simples e num conjunto de dados dos personagens da fraquia Star Wars, respectivamente.
